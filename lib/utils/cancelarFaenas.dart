  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        ...
        // padding: EdgeInsets.only(top: scaledFontSize(15), left: scaledFontSize(15), right: scaledFontSize(15), bottom: scaledFontSize(15)),
      ...
      child: Container(
        padding: EdgeInsets.only(top: scaledFontSize(10.0), bottom: scaledFontSize(10)),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Container(
              height: scaledFontSize(32.0),
              child: Image.asset(
                'assets/images/barcoPesca.png',
                fit: BoxFit.contain,
              ),
            ),
            SizedBox(width: scaledFontSize(20)),
            Text("Cancelar la faena", style: TextStyle(color: colores.white, fontFamily: "NunitoBold", fontSize: scaledFontSize(19)),)
          ],
        ),
      ),
    );
